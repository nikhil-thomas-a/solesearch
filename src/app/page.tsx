...
const HOW_IT_WORKS = [
  { icon: Brain,        num: "01", title: "Tell us about your feet",  desc: "6 simple questions in plain English. No jargon — just describe how your shoes feel today.", color: "#58A6FF" },
        ...
        <div style={{ display: "flex", gap: 20, alignItems: "flex-start", maxWidth: 700 }}>
          ...
          <div>
            ...
            <p style={{ color: "var(--muted)", lineHeight: 1.7, fontSize: 14 }}>
              Our data is sourced from published lab tests, expert reviews, and verified community data. We&apos;re working toward a partnership with{" "}
      ...
      <section style={{ padding: "72px 48px" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 20, padding: "40px 44px", background: "linear-gradient(135deg, rgba(88,166,255,0.06) 0%, rgba(63,185,80,0.04) 100%)", border: "1px solid rgba(88,166,255,0.18)", borderRadius: 16, maxWidth: 700 }}>
          ...
          <p style={{ color: "var(--muted)", lineHeight: 1.7, fontSize: 15 }}>
            Tell us how you use your shoes, your foot shape, and your budget — in plain everyday language. No jargon required.
          </p>
